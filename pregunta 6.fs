...
let main argv = 
    ...
    Console.WriteLine("La suma de sus dos numeros es: "+ restares.ToString())
    let multires = calculadora.multi valor1 valor2
    Console.WriteLine("La suma de sus dos numeros es: "+ multires.ToString())
    let divres = calculadora.dividir valor1 valor2
    Console.WriteLine("La suma de sus dos numeros es: "+ divres.ToString())
